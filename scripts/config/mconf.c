...
"Overview\n"
"--------\n"
"Some features may be built directly into the diagnostic program.\n"
...
load_config_help[] =
	"\n"
	"For various reasons, one may wish to keep several different diagnostic program\n"
...
save_config_help[] =
	"\n"
	"For various reasons, one may wish to keep different diagnostic program\n"
	"configurations available on a single machine.\n"
	"\n"
